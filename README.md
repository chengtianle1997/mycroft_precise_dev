...
### Classify the audio file into train and test settings
...
and the file in ./wake-word and ./not-wake-word folder will be automatically classified to train set and test set
